...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* ===== CONTENT ===== */}
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-32 text-center text-white">
        ...
        {/* 🔥 MAIN TITLE */}
        <h1 className="text-5xl md:text-6xl lg:text-8xl font-extrabold leading-tight mb-8">
          <span className="block text-white">ARTTICON</span>
          <span className="block text-[#F57C00] drop-shadow-lg">
            2026
          </span>
        </h1>
